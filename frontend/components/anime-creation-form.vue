...
const handleCreateAnime = () => {
    if (titleInput.value?.value && descriptionTextArea.value?.value && ratingInput.value?.value) {
        animeStore.createAnime(titleInput.value?.value as string, descriptionTextArea.value?.value as string, ratingInput.value?.valueAsNumber).then(() => {
